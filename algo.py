...
def generate_key():             #generate a random key and encrypt it using affine cipher. 
...
def columnartransposition_decrypt(x,key):       #decrypt using columnar transposition and encrypted key
    key=list(affine_decrypt(key))
    b,a=key.copy(),''
    b.sort()
    for l in key:
